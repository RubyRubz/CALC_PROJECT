exports.function =  (e, calculator, screenNumber) => { //anonymous function in es6 format   
      switch(e.target.dataset.value) {
        ...
        case 'acos':
        calculator.numberPlaceholder = Math.acos(calculator.numberPlaceholder[0])
        screenNumber =  String(calculator.numberPlaceholder)
        console.log(screenNumber)
        ...
        case 'asin':
        calculator.numberPlaceholder = Math.asin(calculator.numberPlaceholder[0])
        screenNumber =  String(calculator.numberPlaceholder)
        console.log(screenNumber)
        ...
        case 'atan':
        calculator.numberPlaceholder = Math.atan(calculator.numberPlaceholder[0])
        screenNumber =  String(calculator.numberPlaceholder)
        console.log(screenNumber)
